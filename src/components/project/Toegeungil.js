                            ...
                            <ul class="overview_text_ul">
                                ...
                                <li> 공통 서버 이슈 & 이미지 관리 문제
                                    ...
                                    <p>
                                        ...
                                        DB에 이미지 URL을 입력하여 Node.js가 이미지를 응답해 줄 수 있도록 구성하였고,
                                ...
                                <li> 트랜잭션 이슈
                                    <p>
                                        jpa로 개발하던 중 취미게시물 수정 로직에서 db에 있는 값을 지우고 다시 넣는 로직이 있었는데
                                        지우고 넣었는대도 같은 식별자값를 가진 다른 객체가 이미 세션과 연결돼있다
                                        라는 오류와 함께 작동하지 않은 경험이 있습니다.
                                    </p>
                                    <p>
                                        문제를 해결하는 도중 hibernate에서 동작하는 SQL 순서가 정해져 있다는 것을 알았습니다.
                                        delete와 insert가 일어나 insert가 먼저 동작한다는 것을 알게 되었고,
                                        문제를 해결하기 위해 delete 하고 flush를 해줘야 하는 걸 알았습니다.
                        ...
                        <div class="overview_text">
                            <ul class="overview_text_ul">
                                ...
                                <li class="dot">프로젝트 완료 리뷰
                                    <p> 기획부터 배포까지 큰 문제없이 재미있게 진행하였으며 잘 마무리되었다고 생각합니다.   </p>
                                    <p>
                                        첫 번째 프로젝트를 기간 내에 끝내지 못한 경험이 있었습니다. 그때는 문제가 발생하면 기다려주기만 했었는데 이번 프로젝트에서는
                                        팀원들끼리 서로 소통하며 먼저 겪었던 문제들을 도와가며 해결하였기 때문에 생각했던 기능들을 구현할 수 있었다고 생각합니다.
                                    ...
                                    <p>
                                        이번 프로젝트가 개인적으로 좋았던 점은 제가 겪었던 문제를 팀원들에게 설명해 주고 해결해 주는 과정에서 저 자신이 더 성장했다고 느꼈습니다.
                                    </p>
                                    <p>
                                        팀원 모두 포기하지 않고 노력해 주었기 때문에 좋은 결과가 나왔다고 생각하고 팀원 모두 발전할 수 있는 계기가 되었다고 생각합니다.
                                    </p>
                                </li>
                            </ul>
                        </div>

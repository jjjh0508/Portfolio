                    ...
                    <div class="common_wrap">
                        ...
                        <div class="overview_text">
                            <ul class="overview_text_ul">
                                ...
                                <li>1. 추가 버튼 문제
                                    <p>
                                        추가 버튼을 누르면 숨겨져 있든 div가 복사되어 추가되는 형식으로 구현하였지만 숨겨져 있는 value 값이 인식해서  계속해서 빈 값이 추가되는 문제가 있었습니다.
                                    </p>
                                    <p>
                                        이를 해결하기 위해 버튼을 누르면 innerHTML+="<div></div>" 로 추가하는 방식으로 변경하여 문제를 해결하였습니다.
                                    </p>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="overview_text">
                            <ul class="overview_text_ul">
                                ...
                                <li class="dot">프로젝트 완료 리뷰
                                    <p> 아쉬움이 많이 남는 프로젝트   </p>
                                    <p>
                                        기간 내에 완성하지 못한 프로젝트라 아쉬움이 많이 남는 프로젝트입니다.
                                        처음 협업을 통한 프로젝트이었다 의사소통이 부족하였고 문제가 발생했을 때 팀원의 성장을 위해 기다렸다 니 시간이 많이 소요되었습니다.
                                        프로젝트를 진행 함에 따라 의사소통하여 서로 맞춰 나가는 것이 중요하다는 걸 알게 되었습니다.

                                    </p>

                                    <p>
                                        로컬 환경에서 각자 DB를 구성하여 사용하였기 때문에 변경 사항이 있을 때마다 팀원 모두 변경해야만 했습니다.
                                        수정 사항이 있을 때마다 바로 공유하고 서로 의사소통했기에 큰 문제없이 마무리 되었다고 생각합니다.
                                    </p>

                                    <p>
                                        이번 프로젝트를 통해 의사소통이 중요하다는 걸 알게 되었습니다.
                                    </p>
                                </li>
                            </ul>
                        </div>
